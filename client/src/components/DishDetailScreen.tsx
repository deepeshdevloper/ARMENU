  ...
  return (
    <div className="fixed inset-0 w-full h-full overflow-hidden bg-gradient-to-br from-gray-900 via-purple-900/30 to-black">
      <button
        ...
        className="absolute top-6 left-6 z-50 p-3 rounded-full glass-effect text-white hover:bg-white/20 transition-all safe-top safe-left"
      >
      ...
      <div className="flex flex-col items-center justify-center h-full px-4 sm:px-6">
        <motion.div
          className="relative w-full max-w-sm sm:max-w-md mb-6 sm:mb-8"
        ...
        >
          <h1 className="text-white text-3xl sm:text-4xl md:text-5xl font-bold mb-2 sm:mb-3 neon-text">
            {selectedDish.emoji} {selectedDish.name}
          </h1>
          <p className="text-white/80 text-base sm:text-lg mb-3 sm:mb-4 px-2">
          ...
          <div className="flex flex-wrap gap-2 justify-center px-4">
            {selectedDish.ingredients.slice(0, 4).map((ingredient, i) => (
              <span 
                key={i}
                className="text-xs sm:text-sm glass-effect text-white px-3 py-1 rounded-full"
              >
                {ingredient}
              </span>
            ))}
        ...
        <motion.button
          ...
          className="relative w-full max-w-sm sm:max-w-md py-3 sm:py-4 rounded-full font-bold text-white overflow-hidden shadow-2xl"
          style={{
        ...
        >
          ...
          <div className="relative flex items-center justify-center gap-2">
            ...
            <span className="text-base sm:text-lg">Enter AR Mode</span>
          </div>
        </motion.button>

        <motion.div
          className="mt-4 sm:mt-6 max-w-sm sm:max-w-md safe-bottom px-4"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.6 }}
        >
          <div className="bg-yellow-500/20 backdrop-blur-sm border border-yellow-500/30 rounded-xl sm:rounded-2xl p-3 sm:p-4">
